...
(function(a){a.Redactor.prototype.fontcolor=function(){return{init:function(){for(var e="#ffffff #000000 #eeece1 #1f497d #4f81bd #c0504d #9bbb59 #8064a2 #4bacc6 #f79646 #ffff00 #f2f2f2 #7f7f7f #ddd9c3 #c6d9f0 #dbe5f1 #f2dcdb #ebf1dd #e5e0ec #dbeef3 #fdeada #fff2ca #d8d8d8 #595959 #c4bd97 #8db3e2 #b8cce4 #e5b9b7 #d7e3bc #ccc1d9 #b7dde8 #fbd5b5 #ffe694 #bfbfbf #3f3f3f #938953 #548dd4 #95b3d7 #d99694 #c3d69b #b2a2c7 #b7dde8 #fac08f #f2c314 #a5a5a5 #262626 #494429 #17365d #366092 #953734 #76923c #5f497a #92cddc #e36c09 #c09100 #7f7f7f #0c0c0c #1d1b10 #0f243e #244061 #632423 #4f6128 #3f3151 #31859b #974806 #7f6000".split(" "),
c=["fontcolor","backcolor"],b=0;2>b;b++){var a=c[b],d=this.button.addBefore("bold",a,this.lang.get(a)),d=this.button.addDropdown(d);d.width(242);this.fontcolor.buildPicker(d,a,e)}},buildPicker:function(e,c,b){var h="backcolor"==c?"background-color":"color";c=b.length;for(var d=this,l=function(b){b.preventDefault();d.fontcolor.set(a(this).data("rule"),a(this).attr("rel"))},f=0;f<c;f++){var k=b[f],g=a('<a rel="'+k+'" data-rule="'+h+'" href="#" style="float: left; font-size: 0; border: 2px solid #fff; padding: 0; margin: 0; width: 22px; height: 22px;"></a>');
g.css("background-color",k);g.on("click",l);e.append(g)}b=a('<a href="#" style="display: block; clear: both; padding: 5px; font-size: 12px; line-height: 1;"></a>').html(this.lang.get("none"));b.on("click",a.proxy(function(b){b.preventDefault();this.fontcolor.remove(h)},this));e.append(b)},set:function(a,c){this.inline.format("span","style",a+": "+c+";")},remove:function(a){this.inline.removeStyleRule(a)}}}})(jQuery);

// Таблицы

(function(c){c.Redactor.prototype.table=function(){return{getTemplate:function(){return String()+'<section id="redactor-modal-table-insert"><label>'+this.lang.get("rows")+'</label><input type="text" size="5" value="2" id="redactor-table-rows" /><label>'+this.lang.get("columns")+'</label><input type="text" size="5" value="3" id="redactor-table-columns" /></section>'},init:function(){var a={};a.insert_table={title:this.lang.get("insert_table"),func:this.table.show,observe:{element:"table","in":{attr:{"class":"redactor-dropdown-link-inactive",
"aria-disabled":!0}}}};a.insert_row_above={title:this.lang.get("insert_row_above"),func:this.table.addRowAbove,observe:{element:"table",out:{attr:{"class":"redactor-dropdown-link-inactive","aria-disabled":!0}}}};a.insert_row_below={title:this.lang.get("insert_row_below"),func:this.table.addRowBelow,observe:{element:"table",out:{attr:{"class":"redactor-dropdown-link-inactive","aria-disabled":!0}}}};a.insert_column_left={title:this.lang.get("insert_column_left"),func:this.table.addColumnLeft,observe:{element:"table",
out:{attr:{"class":"redactor-dropdown-link-inactive","aria-disabled":!0}}}};a.insert_column_right={title:this.lang.get("insert_column_right"),func:this.table.addColumnRight,observe:{element:"table",out:{attr:{"class":"redactor-dropdown-link-inactive","aria-disabled":!0}}}};a.add_head={title:this.lang.get("add_head"),func:this.table.addHead,observe:{element:"table",out:{attr:{"class":"redactor-dropdown-link-inactive","aria-disabled":!0}}}};a.delete_head={title:this.lang.get("delete_head"),func:this.table.deleteHead,
observe:{element:"table",out:{attr:{"class":"redactor-dropdown-link-inactive","aria-disabled":!0}}}};a.delete_column={title:this.lang.get("delete_column"),func:this.table.deleteColumn,observe:{element:"table",out:{attr:{"class":"redactor-dropdown-link-inactive","aria-disabled":!0}}}};a.delete_row={title:this.lang.get("delete_row"),func:this.table.deleteRow,observe:{element:"table",out:{attr:{"class":"redactor-dropdown-link-inactive","aria-disabled":!0}}}};a.delete_table={title:this.lang.get("delete_table"),
func:this.table.deleteTable,observe:{element:"table",out:{attr:{"class":"redactor-dropdown-link-inactive","aria-disabled":!0}}}};this.observe.addButton("td","table");this.observe.addButton("th","table");var b=this.button.addBefore("link","table",this.lang.get("table"));this.button.addDropdown(b,a)},show:function(){this.modal.addTemplate("table",this.table.getTemplate());this.modal.load("table",this.lang.get("insert_table"),300);this.modal.createCancelButton();this.modal.createActionButton(this.lang.get("insert")).on("click",
this.table.insert);this.selection.save();this.modal.show();c("#redactor-table-rows").focus()},insert:function(){this.placeholder.remove();var a=c("#redactor-table-rows").val(),b=c("#redactor-table-columns").val(),d=c("<div>"),e=Math.floor(99999*Math.random()),g=c('<table id="table'+e+'"><tbody></tbody></table>'),f,k,h,l;for(f=0;f<a;f++){k=c("<tr>");for(h=0;h<b;h++)l=c("<td>"+this.opts.invisibleSpace+"</td>"),0===f&&0===h&&l.append(this.selection.getMarker()),c(k).append(l);g.append(k)}d.append(g);
a=d.html();this.modal.close();this.selection.restore();this.table.getTable()||(this.buffer.set(),(b=this.selection.getBlock()||this.selection.getCurrent())&&"BODY"!=b.tagName?("LI"==b.tagName&&(b=c(b).closest("ul, ol")),c(b).after(a)):this.insert.html(a,!1),this.selection.restore(),e=this.$editor.find("#table"+e),a=e.prev("p"),0<a.length&&this.utils.isEmpty(a.html())&&a.remove(),this.opts.linebreaks||!this.utils.browser("mozilla")&&!this.utils.browser("msie")||0===e.next().length&&e.after(this.opts.emptyHtml),
this.observe.buttons(),e.find("span.redactor-selection-marker").remove(),e.removeAttr("id"),this.code.sync(),this.core.setCallback("insertedTable",e))},getTable:function(){var a=c(this.selection.getParent()).closest("table");return this.utils.isRedactorParent(a)&&0!==a.size()?a:!1},restoreAfterDelete:function(a){this.selection.restore();a.find("span.redactor-selection-marker").remove();this.code.sync()},deleteTable:function(){var a=this.table.getTable();if(a){this.buffer.set();var b=a.next();this.opts.linebreaks||
0===b.length?this.caret.setAfter(a):this.caret.setStart(b);a.remove();this.code.sync()}},deleteRow:function(){var a=this.table.getTable();if(a){var b=c(this.selection.getCurrent());this.buffer.set();var b=b.closest("tr"),d=b.prev().length?b.prev():b.next();d.length&&(d=d.children("td, th").first(),d.length&&d.prepend(this.selection.getMarker()));b.remove();this.table.restoreAfterDelete(a)}},deleteColumn:function(){var a=this.table.getTable();if(a){this.buffer.set();var b=c(this.selection.getCurrent()).closest("td, th")[0].cellIndex;
a.find("tr").each(c.proxy(function(a,e){var g=c(e),f=0>b-1?b+1:b-1;0===a&&g.find("td, th").eq(f).prepend(this.selection.getMarker());g.find("td, th").eq(b).remove()},this));this.table.restoreAfterDelete(a)}},addHead:function(){var a=this.table.getTable();if(a)if(this.buffer.set(),0!==a.find("thead").size())this.table.deleteHead();else{var b=a.find("tr").first().clone();b.find("td").replaceWith(c.proxy(function(){return c("<th>").html(this.opts.invisibleSpace)},this));$thead=c("<thead></thead>").append(b);
a.prepend($thead);this.code.sync()}},deleteHead:function(){var a=this.table.getTable();a&&(a=a.find("thead"),0!==a.size()&&(this.buffer.set(),a.remove(),this.code.sync()))},addRowAbove:function(){this.table.addRow("before")},addRowBelow:function(){this.table.addRow("after")},addColumnLeft:function(){this.table.addColumn("before")},addColumnRight:function(){this.table.addColumn("after")},addRow:function(a){if(this.table.getTable()){this.buffer.set();var b=c(this.selection.getCurrent()).closest("tr"),
d=b.clone();d.find("th").replaceWith(function(){var a=c("<td>");a[0].attributes=this.attributes;return a.append(c(this).contents())});d.find("td").html(this.opts.invisibleSpace);"after"==a?b.after(d):b.before(d);this.code.sync()}},addColumn:function(a){var b=this.table.getTable();if(b){var d=0,e=c(this.selection.getCurrent());this.buffer.set();var g=e.closest("tr"),f=e.closest("td, th");g.find("td, th").each(c.proxy(function(a,b){c(b)[0]===f[0]&&(d=a)},this));b.find("tr").each(c.proxy(function(b,
e){var f=c(e).find("td, th").eq(d),g=f.clone();g.html(this.opts.invisibleSpace);"after"==a?f.after(g):f.before(g)},this));this.code.sync()}}}}})(jQuery);

// Видео

(function(b){b.Redactor.prototype.video=function(){return{reUrlYoutube:/https?:\/\/(?:[0-9A-Z-]+\.)?(?:youtu\.be\/|youtube\.com\S*[^\w\-\s])([\w\-]{11})(?=[^\w\-]|$)(?![?=&+%\w.-]*(?:['"][^<>]*>|<\/a>))[?=&+%\w.-]*/ig,reUrlVimeo:/https?:\/\/(www\.)?vimeo.com\/(\d+)($|\/)/,getTemplate:function(){return String()+'<section id="redactor-modal-video-insert"><label>'+this.lang.get("video_html_code")+'</label><textarea id="redactor-insert-video-area" style="height: 160px;"></textarea></section>'},init:function(){var a=
this.button.addAfter("image","video",this.lang.get("video"));this.button.addCallback(a,this.video.show)},show:function(){this.modal.addTemplate("video",this.video.getTemplate());this.modal.load("video",this.lang.get("video"),700);this.modal.createCancelButton();this.modal.createActionButton(this.lang.get("insert")).on("click",this.video.insert);this.selection.save();this.modal.show();b("#redactor-insert-video-area").focus()},insert:function(){var a=b("#redactor-insert-video-area").val();a.match(/<iframe|<video/gi)||
(a=this.clean.stripTags(a),a.match(this.video.reUrlYoutube)?a=a.replace(this.video.reUrlYoutube,'<iframe style="width: 500px; height: 281px;" src="//www.youtube.com/embed/$1" frameborder="0" allowfullscreen></iframe>'):a.match(this.video.reUrlVimeo)&&(a=a.replace(this.video.reUrlVimeo,'<iframe style="width: 500px; height: 281px;" src="//player.vimeo.com/video/$2" frameborder="0" allowfullscreen></iframe>')));this.selection.restore();this.modal.close();var c=this.selection.getBlock()||this.selection.getCurrent();
c?b(c).after(a):this.insert.html(a);this.code.sync()}}}})(jQuery);

// Fullscreen

(function(a){a.Redactor.prototype.fullscreen=function(){return{init:function(){this.fullscreen.isOpen=!1;var a=this.button.add("fullscreen","Fullscreen");this.button.addCallback(a,this.fullscreen.toggle);this.opts.fullscreen&&this.fullscreen.toggle()},enable:function(){this.button.changeIcon("fullscreen","normalscreen");this.button.setActive("fullscreen");this.fullscreen.isOpen=!0;this.opts.toolbarExternal&&(this.fullscreen.toolcss={},this.fullscreen.boxcss={},this.fullscreen.toolcss.width=this.$toolbar.css("width"),
this.fullscreen.toolcss.top=this.$toolbar.css("top"),this.fullscreen.toolcss.position=this.$toolbar.css("position"),this.fullscreen.boxcss.top=this.$box.css("top"));this.fullscreen.height=this.$editor.height();this.opts.maxHeight&&this.$editor.css("max-height","");this.opts.minHeight&&this.$editor.css("min-height","");this.$fullscreenPlaceholder||(this.$fullscreenPlaceholder=a("<div/>"));this.$fullscreenPlaceholder.insertAfter(this.$box);this.$box.appendTo(document.body);this.$box.addClass("redactor-box-fullscreen");
a("body, html").css("overflow","hidden");this.fullscreen.resize();a(window).on("resize.redactor.fullscreen",a.proxy(this.fullscreen.resize,this));a(document).scrollTop(0,0);a(".redactor-toolbar-tooltip").hide();this.$editor.focus();this.observe.load()},disable:function(){this.button.removeIcon("fullscreen","normalscreen");this.button.setInactive("fullscreen");this.fullscreen.isOpen=!1;a(window).off("resize.redactor.fullscreen");a("body, html").css("overflow","");this.$box.insertBefore(this.$fullscreenPlaceholder);
